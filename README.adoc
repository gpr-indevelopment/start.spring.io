...
----
Alternatively, you can choose the port for the server application with debugging capabilities:

[indent=0]
----
    $ ../mvnw spring-boot:run -Drun.jvmArguments='-Dserver.port=8081 -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005'
----
